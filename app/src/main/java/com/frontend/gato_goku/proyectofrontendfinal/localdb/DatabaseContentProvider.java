...
import com.frontend.gato_goku.proyectofrontendfinal.localdb.SQLiteHelper;
...
public class DatabaseContentProvider extends ContentProvider {
    ...
    private void initUris() {
        ...
        uriMatcher.addURI("com.frontend.gato_goku.proyectofrontendfinal.sqlprovider", "DELEGACION/", 1);

        // This will match: content://io.pello.android.androidsyncadapter.sqlprovider.Todo/task/2
        uriMatcher.addURI("com.frontend.gato_goku.proyectofrontendfinal.sqlprovider.todo", "DELEGACION/*/", 2);
        ...
        uriMatcher.addURI("com.frontend.gato_goku.proyectofrontendfinal.sqlprovider.todo", "DELEGACION/last/backend", 3);

        // This will match: content://io.pello.android.androidsyncadapter.sqlprovider.Todo/tasks/last/local
        uriMatcher.addURI("com.frontend.gato_goku.proyectofrontendfinal.sqlprovider.todo", "DELEGACION/last/local", 4);
    ...
    public Cursor query(Uri uri, String[] projection, String selection,String[] selectionArgs, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            case 1:
                ...
                //mCursor = dbAdapter.obtenerTareas();
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            case TODOS:
                rowsDeleted = sqlDB.delete(String.valueOf(delegacion.getId()), selection,
                        selectionArgs);
                break;
            case TODO_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    rowsDeleted = sqlDB.delete(
                            String.valueOf(delegacion.getId()),
                            delegacion.getId() + "=" + id,
                            null);
                } else {
                    rowsDeleted = sqlDB.delete(
    ...
    public Uri insert(Uri uri, ContentValues values) {
      ...
      Delegacion delegacion = new Delegacion(
        ...
        dbAdapter.insertarTarea(delegacion);
